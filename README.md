# QA Case Study: Исследование реального веб-приложения (IT-услуги)

**Цель проекта:** Проведение исследовательского тестирования (Exploratory Testing) корпоративного портала крупной IT-компании. 
**Стек:** Chrome DevTools, Safari Web Inspector, Screen-to-Gif/Lightshot.
...
**Описание:** 
Система сообщает об успешной отправке формы, в то время как на стороне сервера происходит сбой почтового шлюза. 
...
**Окружение:** macOS Safari / Chrome (Emulation mode).

---

## 🛠 Методология
В ходе тестирования использовался подход **Black Box**. При обнаружении ошибки отправки формы был проведен дополнительный анализ сетевых запросов (Network Tab) для локализации проблемы на стыке Frontend и Backend.
